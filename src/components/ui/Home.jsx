        ...
        <div className="px-4 py-12 md:px-8">
          ...
          <div className="flex flex-wrap justify-center sm:justify-start sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mt-20 mb-4">
            ...
            <Link
              ...
              target="_blank"
              className="inline-block px-8 py-4 text-xl font-bold text-white bg-[#2A69EF] rounded-lg text-center hover:bg-blue-600 transition-colors w-full sm:w-auto sm:mx-2"
            >
